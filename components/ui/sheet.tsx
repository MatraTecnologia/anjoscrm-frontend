    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "[background:rgba(6,12,30,0.92)] [backdrop-filter:blur(28px)] [border-left:1px_solid_rgba(255,255,255,0.07)] [box-shadow:-24px_0_64px_rgba(0,0,0,0.5)] data-[side=left]:[border-left:none] data-[side=left]:[border-right:1px_solid_rgba(255,255,255,0.07)]",
          className
        )}
        {...props}
      >
